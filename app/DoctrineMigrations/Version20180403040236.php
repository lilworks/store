 ...
 */
class Version20180403040236 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE lilworks_store_info (id INT AUTO_INCREMENT NOT NULL, tag VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, value LONGTEXT DEFAULT NULL COLLATE utf8_unicode_ci, pictureName VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, updatedAt DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
