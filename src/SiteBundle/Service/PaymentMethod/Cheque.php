...
*/
        ...
        $dataToSend[$datas['AMOUNT_NAME']]=$order->getTot();
...
/*
 * vads_action_mode + vads_amount + vads_ctx_mode + vads_currency + vads_cust_email + vads_page_action + vads_payment_config + vads_site_id + vads_trans_date + vads_trans_id + vads_url_return + vads_version + certificate
 * */
        //var_dump($field);
        //echo "vads_action_mode + vads_amount + vads_ctx_mode + vads_currency + vads_cust_email + vads_page_action + vads_payment_config + vads_site_id + vads_trans_date + vads_trans_id + vads_url_return + vads_version + certificate";
        $contenu_signature = "";
